...
Stability selection \cite{meinshausen2010stability}  is a subsampling strategy with a range of applications, including the estimation of significance in regression models where 
...
number of times the SNP was in the top 20 SNPs divided by the number of replicates. 
