...
\section{Simulation Study}
Genome-wide data are generated under five different scenarios. These five scenarios partially mimic the size of study being performed in 
animals, plants, and humans. They are a GWAS of size 150 individuals 
and 5,000 single nucleotide polymorphisms (SNPs) (150 x 5K),  350 individuals and 400,000 SNPs (350 X 400K),  1,500 individuals and 
50,000 SNPs (1500 x 50K), 2,000 individuals and 500,000 SNPs (2000 x 500K), 4,000 individuals and 
1,500,000 SNPs (4000 x 1.5M), and 10,000 individuals and 1,500,000 SNPs (10000 x 1.5M).   


To generate a replicate, we used data perturbation (ref). Data perturbation makes use of real genotype data from which a (quantitative) trait is created. With data perturbation, we are able to preserve some of the challenges of analysing real data while still having trait data whose genetic architecture is known. We obtained the genotype data from the 1000 Genome Project, version 3   \cite{10002010map} consisting of over
78 million autosomal SNPs collected from 2504 individuals across 26 populations.  To form the genotype data, we 
sampled randomly from the 2504 individuals and 78 million loci according to the specifications of the scenario. 

According to the specifications of the scenario,
we identified, randomly, the individuals and loci. We then extracted this information from the larger data set 
to form the genotype data for a scenario. The individuals 
and loci chosen varied across scenarios but the same genotype data were used across the 100 replicates within a scenario. 


 The original data contains X individuals with XX XX snp. From these data, according to the specifications of the scenario, the individuals and the snp loci are identified at random. What about polymorphic affect numbers? Chech).
