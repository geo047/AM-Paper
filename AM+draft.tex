...
First, is Eagle faster, computationally, than other competing implementations? Second, is Eagle better, statistically, at 
identifying the snp closest to the genes that are influencing a trait? To answer these questions, we conducted a large 
simulation study. 



First, how does Eagle compare, computationally, to other competing implementations? Second, 
how accurate is Eagle for finding 
