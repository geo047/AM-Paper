...
the statistical power and false discovery rates of the different methods across the six scenarios. We did this by recording the set of snp that had been selected for generating a replicate's trait data. 
These snp are in true association with the trait. Each replicate had a different set of selected snp. We then determined for a method
