...
the fdr as the significance threshold (and underlying significance level) is varied. 




In Figure X, the power and fdr of Eagle are compared to the other multiple locus methods. For a comparison with single-locus methods, 
