...
Of the five multiple locus methods considered, BigRR, LMM-Lasso, and glmnet,  implement regularization methods for parameter
...
genomic prediction (refs) but also association mapping (refs). BigRR is an R package that implements generalized ridge regression
which is an improvement on standard ridge regression. In standard ridge regression, coefficients of the predictors are shrunk 
