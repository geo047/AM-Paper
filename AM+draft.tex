...
Glmnet is a general purpose R package for statistical analysis. It implements elastic net regression, 
a regularisation method that has been applied to generalised linear models \cite{zou2005regularization}.   
Glmnet was not specifically built for association mapping. However, we included it amongst the applications to benchmark 
