...
for data from scenario 10000x1.5M. 


As the data sets became large, (4000x1.5m and 10000x1.5m), the multiple locus implementations memory footprint become excessive. Some even struggled with memory for data generated under 2000 x 500k. GEMMA, a single locus implementation had the lowest memory usage (sup figure 1). However, Eagle, with its ability to handle data larger than the memory capacity of the computer, was the only multiple locus implementation capable of producing findings for data from 10000x1.5m.
