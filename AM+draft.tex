...
BigRR is an R package that implements generalized ridge regression. Generalized ridge regression is 
 an improvement on ridge regression. In ridge regression, coefficients of the predictors are shrunk 
...
Lmm-Lasso  \cite{rakitsch2013lasso} is a stand-alone computer program that implements lasso within a linear mixed model 
...
Glmnet  \cite{Friedman2010glmnet}, unlike BigRR and LMM-Lasso, was not purpose built for 
...
Of the multiple-locus applications considered in this paper, 
