...
Each takes a different approach to multiple-locus association mapping. A summary of the key attributes to the different computer programs/packages 
is given in Supplementary Table \ref{suptabsummary}. 
Further details about the computer programs/packages and how they were used in the analysis of the simulated data can be found in Methods.
