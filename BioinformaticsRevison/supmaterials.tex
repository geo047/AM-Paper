...
\begin{figure}
\caption{Power verse false positive rates for Eagle and the multi-locus methods. Plots for only those simulation 
scenarios where all multi-locus methods could be implemented are shown.  Eagle has the highest power across the four 
scenarios but MLMM also performs well. A false posirive rate of greater than 10\% is typically not employed in GWASs so the 
...
Eagle$^{alt}$  & Bioch.HDL   & 6   & 17.53         & Muscles.Sol.g Muscles.TA.g Muscles.Plant.g Muscles.EDL.g  Muscles.Gast.g 
 ...
 Eagle$^{optimal}$  &        Bioch.Tot.Cholesterol  & 4      &  134.58  & FACS.CD3posCD44posCD4CD8Ratio  \\
                        ...
                        & Bioch.HDL                                   & 6      &    17.53   & Muscles.Sol.g Muscles.TA.g Muscles.Plant.g Muscles.EDL.g  Muscles.Gast.g 
     SPPI.ln.pa Bioch.Calcium    Bioch.Tot.Cholesterol Bioch.Tot.Protein Bioch.Albumin  \\
...
(pink horizontal line) and permutation (purple horizontal line), at a 5\% significance level. 
}
\label{supmanhattan}
\begin{center}
